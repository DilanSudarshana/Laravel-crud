            ...
            <section class="text-center">
                ...
                <div class="row">
                    @foreach ($posts as $post)
                        <div class="col-lg-4 col-md-6 mb-4"> <!-- Use col-lg-4 to create three columns on large screens, and col-md-6 for medium screens -->
                            <div class="card">
                        ...
                        @php 
                            $count++; 
                            if ($count % 3 == 0) echo '</div><div class="row">'; // Close and reopen row every 3 columns
                        @endphp
                    @endforeach
                </div>
            </section>
